...
<div class="tc justify-around">
    <div class="tc">
        <ul>
          ...
          <li class="list f5-ns fw5 dib tc ph5"> <!-- dib = "display inline block"-->
            <a class="hover-blue no-underline gray f4 fw3 lh-copy" href="/performances-appearances/">appearance history</a>
          </li>
           <li class="list f5-ns fw5 dib tc ph5"> <!-- dib = "display inline block"-->
...
Currently, Ted is a Lecturer in the Discipline of Music at Columbia University where he serves as Interim Director of the Computer Music Center and Interim Assistant Director of the Sound Art Program.
